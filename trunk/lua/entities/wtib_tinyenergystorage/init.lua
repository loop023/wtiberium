...
function ENT:Initialize()
	self:SetModel("models/Items/battery.mdl") --NightReaper:need make a tiny energy cell model and ammend this line
	...
	WTib_AddResource(self,"energy",750)
	WTib_RegisterEnt(self,"Storage")
end

function ENT:SpawnFunction(p,t)
	if !t.Hit then return end
	local e = ents.Create("wtib_tinyenergystorage")
	e:SetPos(t.HitPos+t.HitNormal*1) --NightReaper:this line will need to be ammended when a tiny energy cell model exists
	e.WDSO = p
	e:Spawn()
	e:Activate()
	return e
