...
ENT.ReproductionRate			= 35 -- Howmuch seconds are being added to the console command of the respawn rate for this ent.
...
ENT.ReproduceDelay				= 70 -- The delay between reproductions when damaged.
