...
ENT.Warheads =	{
					...
					EnergyRequired=100,RefinedTiberiumRequired=200,TiberiumChemicalsRequired=0,Class="wtib_warhead_basic",Pos=Vector(65,0,-20)},

					{name="Advanced Warhead",Discription="The more powerfull warhead, also more expensive.",
					EnergyRequired=150,RefinedTiberiumRequired=300,TiberiumChemicalsRequired=0,Class="wtib_warhead_advanced",Pos=Vector(65,0,-20)},

					{name="Seeder Warhead",Discription="A powerfull warhead that seeds the battlefield with green tiberium.",
					EnergyRequired=600,RefinedTiberiumRequired=200,TiberiumChemicalsRequired=500,Class="wtib_warhead_seeder",Pos=Vector(65,0,-20)},
